...
<head>
	...
	<title>Home</title>	
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/favicon.ico.png">
							...
							<ul>
								...
								<li class="menu-item lang-menu menu-item-has-children parent">
									...
									<ul class="submenu lang" >
										...
										<li class="menu-item" ><a title="Brazil" href="#"><span class="img label-before"><img src="assets/images/lang-bra.png" alt="lang-bra"></span>Brazil</a></li>
									</ul>
								</li>
					...
					<div class="primary-nav-section">
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								...
								<li class="menu-item">
									<a href="{{ route('about.index')}}" class="link-term mercado-item-title">About Us</a>
								</li>
								<li class="menu-item">
			...
			<div class="coppy-right-box">
				<div class="container">
					<div class="coppy-right-item item-left">
						<a href="https://www.linkedin.com/in/magnum-souza-064404151/" class="coppy-right-text">Copyright © 2024 Magnata Technology - Magnum Souza. All rights reserved</p>
					</div>
